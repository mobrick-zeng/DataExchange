...
export function TextField({ label, error, hint, id, className = '', ...rest }: TextFieldProps) {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        id={fieldId}
        className={`w-full rounded-xl border bg-surface-muted px-3.5 py-2.5 text-sm text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-500/60 ${
