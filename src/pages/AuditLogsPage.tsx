...
const ACTION_LABELS: Record<string, string> = {
  ...
  CASE_CREATED: '建立案件', CASE_UPDATED: '編輯案件', PARTICIPANT_INVITED: '邀請債權行',
  PARTICIPANT_REMOVED: '移出債權行', PARTICIPATION_REJECTED: '拒絕參與', CASE_PUBLISHED: '發布案件',
  DECLARATION_SUBMITTED: '申報債權', CASE_CONFIRMED: '確認自己', CONFIRMATION_WITHDRAWN: '撤回確認',
  CASE_DISCLOSED: '揭露彙整', DOUBT_RAISED: '標記疑義', CASE_ESTABLISHED: '回報成立', CASE_NOT_ESTABLISHED: '回報不成立',
